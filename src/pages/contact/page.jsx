                    ...
                    <div className=" flex flex-col lg:flex-row justify-between items-start gap-10 w-full ">
                        <div className=" lg:w-1/2 flex flex-col items-start gap-4">
                            <div className=" flex flex-row justify-between items-center gap-4 w-full">
                                <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange}  id="" className={`${!formData.fullName && validation && "border-red-500 placeholder:text-red-500 "} border-2 border-primary w-full h-12 rounded-4xl pl-6 placeholder:text-white font-chillax`} placeholder="Nom complet" />
                                <input type="text" name="email" value={formData.email} onChange={handleInputChange}  id="" className={` ${!formData.email && validation && "border-red-500 placeholder:text-red-500 "} border-2 border-primary w-full h-12 rounded-4xl pl-6 placeholder:text-white font-chillax`} placeholder="Email"/>
                            </div>
                            <input type="text" name="phone" value={formData.phone} onChange={handleInputChange}  id="" className={` ${!formData.phone && validation && "border-red-500 placeholder:text-red-500 "} border-2 border-primary w-full h-12 rounded-4xl pl-6 placeholder:text-white font-chillax`} placeholder="Numéro de téléphone"/>
                            <textarea  rows={6} name="comment" value={formData.comment} onChange={handleInputChange}  className={` text-white border-2 border-primary w-full  rounded-4xl p-6 placeholder:text-white font-chillax`} placeholder="Commentaire Ou Question" id=""></textarea>
