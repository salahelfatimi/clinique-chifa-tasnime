                    ...
                    <div className=" flex flex-col lg:flex-row justify-between items-start gap-10 w-full ">
                        ...
                        <div className=" lg:w-1/2 flex flex-col gap-3 items-start justify-start">
                            ...
                            <div className=" flex flex-col justify-start items-start w-full gap-4" >
                                <h3 className=" text-primary font-medium  border-2 w-full text-start p-2 font-chillax flex gap-2 "><MapPin /> Localisation</h3>
                                <span className=" text-white text-sm border-primary font-zodiak border-l-4 pl-4">4 Rue Ibn Toummert, Marrakesh 40000</span>
                            </div>
                            <div className=" flex flex-col justify-start items-start w-full gap-4" >
                                <h3 className=" text-primary  font-medium  border-2 w-full text-start p-2 font-chillax flex gap-2"><Phone/> Téléphone</h3>
                            ...
                            <div className=" flex flex-col justify-start items-start w-full gap-4" >
                                <h3 className=" text-primary font-medium  border-2 w-full text-start p-2 font-chillax flex gap-2 "><Mail /> E-mail</h3>
