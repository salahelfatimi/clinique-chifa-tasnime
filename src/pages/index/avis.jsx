"use client" 
import { testimonials } from "@/app/data/avis";
    ...
    return (
        <div className="py-10 container mx-auto px-3 flex flex-col gap-10">
            <div className="flex items-center justify-center flex-col gap-6 text-center px-4">
                <Image src={"/img/logo.png"} width={500} height={500} alt="Logo" className="w-36 lg:w-40 mx-auto" />
                <p className="text-2xl sm:text-3xl lg:text-6xl font-zodiak text-background">
                    DÉCOUVREZ CE QUE NOS PATIENTS DISENT DE NOS SERVICES DE SANTÉ ET DE BIEN-ÊTRE
                </p>
            </div>

            <div className="overflow-hidden w-full max-w-6xl mx-auto cursor-grab active:cursor-grabbing" ref={emblaRef}>
