    ...
    return(
        <div>
            <div className="h-screen relative ">
                <Image src={'/img/specialites/img.jpg'} alt="FAQ" fill className="object-cover object-center" />
            ...
            <div className=" bg-background text-white py-8">
                <p className=" text-xl font-chillax text-center container mx-auto text-white">La Clinique Chifa est fière de proposer une large gamme de services médicaux spécialisés, adaptés à tous vos besoins de santé. <br /> Nos équipes expérimentées, soutenues par une technologie de pointe, travaillent jour et nuit pour offrir des soins d'excellence. Découvrez nos services en détail ci-dessous.</p>
            </div>
            <div> 
                <div className="   ">
                        ...
                        {PageService.map((item, index) => (
                            <div key={index} className="flex flex-col lg:even:flex-row lg:odd:flex-row-reverse odd:bg-secondary even:bg-primary  items-center justify-center  ">
                                ...
                                <div className="flex flex-col gap-6 lg:w-1/2 p-8">
                                    <h3 className="text-4xl uppercase font-zodiak text-center mb-4 text-white">  {item.title}</h3>
                                    <p className="text-white text-center font-chillax">{item.description}</p>
                                    <Link href={'#'} className=" bg-white w-full text-center py-3 font-chillax text-lg rounded-2xl font-medium text-background  shadow-2xl hover:bg-primary hover:text-white duration-700">Lire Plus</Link>
                                </div>
